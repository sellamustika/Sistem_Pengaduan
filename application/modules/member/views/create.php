                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input name="tgl_terima" class="form-control datepicker" placeholder="Select date" type="text" value="">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label class="form-control-label" for="exampleDatepicker">Tanggal Aplikasi</label>
                        <input name="tgl_aplikasi" class="form-control datepicker" placeholder="Select date" type="text" value="">
                      </div>
                    </div>
                  </div>
              </div>
