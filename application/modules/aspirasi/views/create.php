...
<?php $this->load->view("dashboard/_partials/sidebar.php")?>
  ...
  <?php endif; ?>
    ...
    <!-- Page content -->
  <form action="<?php echo base_url('aspirasi/add')?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-lg-6">
          <div class="card-wrapper">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <a href="<?php echo base_url('aspirasi')?>"><button class="btn btn-secondary" type="button">Batal</button></a>
