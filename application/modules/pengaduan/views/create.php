...
<?php $this->load->view("dashboard/_partials/sidebar.php")?>
  ...
  <?php endif; ?>
    ...
    <!-- Page content -->
  <form action="<?php echo base_url('pengaduan/add')?>" method="POST" enctype="multipart/form-data">
                ...
                <!-- s -->
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="form-group">
                        <div class="input-group input-group-merge">
                          <label class="form-control-label" for="exampleDatepicker">Pilih Kategori</label>
...
<!-- 
                    <div class="col-md-12">
                      <div class="form-group">
                        <label class="form-control-label" for="exampleDatepicker">Jenis</label>
                        <div class="input-group input-group-merge">
                          <div class="input-group-prepend">
                            <span class="input-group-text"><i class="fas fa-user"></i></span>
                          </div>
                          <input type="text" name="jenis" class="form-control" placeholder="Jenis Pengaduan">
                        </div>
                      </div>
                    </div> -->
                  ...
                  <div class="row">
                        <div class="col-md-3">
                          <div class="custom-control custom-radio mb-3">
                            <input name="status" class="custom-control-input" id="customRadio5" type="radio" value="dilihat">
                            <label class="custom-control-label" for="customRadio5">Dilihat</label>
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="custom-control custom-radio mb-3">
                            <input name="status" class="custom-control-input" id="customRadio6" type="radio" value="belum">
        ...
        <div class="col-lg-6">
          <div class="card-wrapper">
              ...
              <div class="card-body">
                  <div class="row">
                   ...
                   <div class="form-group">
                    ...
                    <textarea class="form-control" type = "text" name="deskripsi"  rows="4"></textarea>
                  </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <a href="<?php echo base_url('pengaduan')?>"><button class="btn btn-secondary" type="button">Batal</button></a>
