...
<?php $this->load->view("dashboard/_partials/sidebar.php")?>
  ...
  <?php endif; ?>
    ...
    <!-- Page content -->
  <form action="<?php echo base_url('form/tambah')?>" method="POST" enctype="multipart/form-data">
          ...
          <div class="card-wrapper">
            ...
            <div class="card">
              ...
              <div class="card-header">
                <h1 class="mb-0">Aspirasi</h1>
                <h4 class="mb-2">Sampaikan aspirasimu </h4>
              </div>
              <!-- Card body -->
              <div class="card-body">
                <!-- s -->
